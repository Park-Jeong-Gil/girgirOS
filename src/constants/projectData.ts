...
<div class="siteDesc">
  ...
  <p>
    <strong>Cosmofy</strong>는 cosmos(우주) + comfy(편안함)의
    합성어로 온전하게 개인만을 위한 프라이빗 SNS 입니다.
  </p>
  <p>
    현재의 SNS는 사용자들에게 소통의 즐거움을 주는 반면, 피로감도
    동반 할 수 밖에 없다고 생각 합니다. 알고리즘에 의한 광고도
    그렇고, 사적인 기록마저 익명의 불특정 다수에게 노출 되어야
    하는 구조니까요.
  </p>
  <p>
    저는 이 부분이 현재 SNS의 명암이라 생각하고. 개인적인 공간에
    게시글을 올리면서도 경우에 따라 제한적인 공유와 소통이 가능한,
    그런 SNS를 만들어보자는 생각에서 <strong>Cosmofy</strong>를 개발하게 되었습니다.
  </p>

  <p>
    아직은 서비스라 부르기도 민망한 지극히 개인적인 토이
    프로젝트이지만, 그래서 어설픈 부분도 많고 오류도 있겠지만,
    <br>
    언젠간 정식 서비스가 되어 저 처럼 현재의 SNS에 피로감을 느끼는
    사람들에게 편안함과 도움이 되는, 그런 서비스가 되도록 꾸준히
    업데이트 할 예정 입니다.
  </p>
</div>
    `,
