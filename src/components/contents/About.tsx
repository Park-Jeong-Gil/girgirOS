  ...
  return (
    <div className="bodyInner">
      ...
      <div className="descBox">
        <strong>
          Welcome to <span>Girgir's</span> Portfolio!
        </strong>
        <div className="description">
          ...
          <ul>
            <li>
              깜짝 놀라셨나요? 이 웹 사이트는 레트로 PC <br />
              컨셉으로 제작된 웹 포트폴리오 입니다.
            </li>
            <li>
              해당 포트폴리오는 PC 풀 스크린 사이즈에 <br />
              최적화 되어 있습니다.
            </li>
            <li>
              실제 PC 처럼 아이콘을 <strong>더블 클릭</strong> 하여 내용을
              <br />
              확인 할 수 있습니다.
            </li>
        ...
        <ul>
          {Object.keys(programs).map((key) => {
            ...
            return (
              <li key={item.ID} className={`helpIcon ${item.ID}`}>
                : {item.DESCRIPTION}
              </li>
            );
          })}
        ...
        <div className="btnWrap">
          ...
          <button className="aboutCloseBtn" onClick={handleClose}>
            닫기
          </button>
        </div>
      </div>
